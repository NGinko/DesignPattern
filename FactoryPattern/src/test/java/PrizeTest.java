...
import designNormal.AwardReq;
import designNormal.AwardRes;
import designNormal.PrizeController;
...
/**
 * @author NGinko
 * @date 2022-01-18 23:13
 */
public class PrizeTest {

    private Logger logger = LoggerFactory.getLogger(PrizeTest.class);
